...
CONFLICT_DRAFT_CHARS = int(os.getenv("CONFLICT_MAX_DRAFT_CHARS", "1500"))
CONFLICT_CONTEXT_CHARS = int(os.getenv("CONFLICT_MAX_CONTEXT_CHARS", "3500"))
CONFLICT_EXCERPT_CHARS = int(os.getenv("CONFLICT_EXCERPT_CHARS", "500"))
